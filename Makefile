...
rtd: 
	cp -rv 002_objects_management 007_device_management *rst scripts Makefile make.bat README.md datas _images _static conf.py images index.rst .readthedocs.yaml requirements.txt dockerfile ../github_howto_jsonrpc_api/
