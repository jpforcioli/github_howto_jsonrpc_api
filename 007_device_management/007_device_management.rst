...
How to force a Model Device to be auto-linked?
++++++++++++++++++++++++++++++++++++++++++++++
           ...
           "params": [
             {
               ...
               "url": "/cli/global/exec/fgfm/autolink-device/dev_001"
             }
           ],
           "session": "{{session}}"
         }
...
The example below shows how to delete the device group ``grp_001`` from the ``demo`` ADOM.
   ...
   .. tab-item:: REQUEST
      ...
      .. code-block:: json

         {
           ...
           "params": [
             {
               "url": "/dvmdb/adom/demo/group/grp_001"
             }
           ],
           "session": "{{session}}"
         }
