...
How to get firewall addgrp members along with their details?
------------------------------------------------------------
...
- To retrieve firewall address included in a specific IP address
  ...
  In the below example, we want all firewall addresses belonging to IP
  subnet 3.14.142.0/24:
...
- To retrieve firewall address strictly matching a specic IP address
  ...
  In the below example, we want all firewall addresses with an exact
  match for IP address 3.14.142.63/32:
...
- To retrieve all firewall addresses containing a specific IP address
  ...
  In the below example, we want all firewall addresses containing IP
  10.1.0.111/32.
...
Header/Footer IPS sensor
++++++++++++++++++++++++

How to create a Header/Footer IPS sensor?
_________________________________________

Note: to rewrite with less attributes.
...
.. code-block:: json
   ...
   {
     "id": "76d384f4-4d41-4743-ae4e-471675136521",
     "method": "add",
     "params": [
       {
...
How to delete  Header/Footer IPS sensor?
...
.. code-block:: json
   ...
   {
     "id": "ad991245-e74d-468e-b0c8-36b0744176a2",
     "method": "delete",
     "params": [
       {
         "url": "pm/config/global/obj/global/ips/sensor/foobar",
         "confirm": 1
       }
     ]
   }
...
.. warning::
   ...
   You cannot delete a Header/Footer IPS sensor if it is associated to ADOMs.

How to associate ADOMs to a Header/Footer IPS sensor?
_____________________________________________________

Note: to rewrite with method add (update the URL)
...
.. code-block:: json
   ...
   {
     "id": "dfbb81e9-eacb-44cd-825f-955d3f3cdfa6",
     "method": "update",
     "params": [
       {
         "url": "pm/config/global/obj/global/ips/sensor/foobar",
...
How to assign a Header/Footer IPS sensor?
_________________________________________
...
.. code-block:: json
   ...
   {
     "id": "b72ab620-eaac-48f6-98b1-ed1532fbe548",
     "method": "exec",
     "params": [
       {
         "url": "/securityconsole/assign/objs",
...
Note: to double check the result...
